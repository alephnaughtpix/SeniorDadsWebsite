require "#{File.dirname(__FILE__)}/../code/SiteFile"
require 'date'
class Demo
    ...
    def initialize( id, name, platform, size, releaseDate, mainFile, mirrorFiles, gfxFiles )
        ...
        @mainFile = SiteFile.new("[d0Wnl0Ad!!11]",mainFile)
        unless mirrorFiles.nil?
            @mirrorFiles = [mirrorFiles.size]
            (0..mirrorFiles.size-1).each do |i|
                @mirrorFiles[i] = SiteFile.new(@@mirrorNames[i],mirrorFiles[i])
            end
        end
    ...
    def self.LoadAll
        Demo.new(
            ...
            [
                SiteFile.new("A legend is born!!!!","../images/demos/atuck.gif")
            ]
        )
        Demo.new(
            2,
            ...
            [
                SiteFile.new("Back with a splash!!(!!)","../images/demos/colonic.gif")
            ]
        )
        Demo.new(
            3,
            ...
            [
                SiteFile.new("Our first big one!!(!!)","../images/demos/ladmds2.gif")
            ]
        )
        Demo.new(
            4,
            ...
            [
                SiteFile.new("The screen that launched a new era in Atari demoes!!!!","../images/demos/airdirt.jpg")
            ]
        )
        Demo.new(
            5,
            ...
            [
                SiteFile.new("This is what happens when inferior coders ripp you off!!!!","../images/demos/floormat.gif")
            ]
        )
        Demo.new(
            6,
            ...
            [
                SiteFile.new("HARDCORE YOU KNOW THA SCORE!!!!","../images/demos/teckno.gif")
            ]
        )
        Demo.new(
            7,
            ...
            nil,
            [
                SiteFile.new("Merrey Xmas, everyboddy!!!!","../images/demos/xmas97.jpg")
            ]
        )
        Demo.new(
            8,
            ...
            nil,
            [
                SiteFile.new("Can you believe this was done in 128 bytes?!?!?","../images/demos/dadplazz.png")
            ]
        )
        Demo.new(
            9,
            ...
            nil,
            [
                SiteFile.new("Back to mono!!!!","../images/demos/mono/testcard.gif")
            ]
        )
        Demo.new(
            10,
            ...
            nil,
            [
                SiteFile.new("Our first FAKE demo!!!","../images/demos/fake.gi")
            ]
        )
    end

    def GetNext
        Demo.GetByID(self.id +1)
    end
