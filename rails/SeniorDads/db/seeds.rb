...
music_file_0 = MusicFile.create(name: "fanfare", title: "Senior Dads Fanfare", description: "At the start of every Dads demo- this was the version at the start of <a href=\"../demos/atuck.html\">Anal Tuck</a>. It signifies the end of the crumbling empire attitudes of those opposed to <em>&quot;one nation under a techno groove&quot;,</em> know what I'm saying?", main_file: link_58)
music_file_1 = MusicFile.create(name: "theme", title: "Senior Dads Theme", description: "From <a href=\"../images/demos/colonic.html\">Colonic Irrigation</a>. It samples bits of the fanfare and twists and turns it over a happy hardcore/jungle ragga stylee. Mad, like a raving nuttah, but that's the kind of guy I am, you catching my drift?", main_file: link_59)
music_file_2 = MusicFile.create(name: "laurent", title: "Laurent Garnier, Kiss My Derriere", description: "From the <a href=\"../demos/ladmds2.html\">L'Aube Du Matin Du Soir II (Remix)</a> intro. Mad karazee froggy-style techno trance monsta! Goes into record-breaking style bpm frenzy mania at the end, just to start the weekend off for the cool French Atrocity demo!", main_file: link_60)
music_file_3 = MusicFile.create(name: "liam", title: "Liam Gallagher, Kiss My Derriere (The Burp Song)", description: "Also from the <a href=\"../demos/ladmds2.html\">L'Aube Du Matin Du Soir II (Remix)</a>, this time from the endtro. Made to piss off that thick Neanderthal troglodyte Manc bastardo Gallagher twat, who said that people would dance to farts if they stuck beats on top of them. Well, of course they would, most beats-fortified farts hit the spot better than your shit-for-brains Beatle rip-offs, you top prize wankaah! So I made this killer chune completely outta burps! Beat that, <strong>Oasisn't</strong>!!!", main_file: link_61)
music_file_4 = MusicFile.create(name: "MoveYourAss", title: "Move Your Ass To The Senior Dads", description: "The monsta rave theme toon from the megademo <a href=\"../demos/airdirt.html\">Air Dirt</a>. A classic dance floor filla that piles on tha crazee manic beats until it explodes! Treat with care, I take <strong>no</strong> responsibility if you spontaneously combust whilst listening to this twisted firestarter of a chune!", main_file: link_62)
music_file_5 = MusicFile.create(name: "XmasBalls", title: "Kick Santa in the Balls", description: "From <a href=\"../demos/xmas97.html\">Xmas Card 97</a>. It's Christmastime, and there's a need to be afraid... Cause the Dame VL is kickin' it again with the ill-est Xmas Medley ever, dropping like a Hiroshima for the earholes, know what I'm saying?", main_file: link_63)
music_file_6 = MusicFile.create(name: "NeverMindThePistols", title: "Never Mind the Pistols, Here's the Bollocks", description: "From the <a href=\"../demos/teckno.html\">Anti-Teckno Teckno demo</a>. A pumping techno soundtrack (This is 1992, so it sounds a bit more laid-back now!!!) BTW This is the first techno module ever in ST chip musix!", main_file: link_64)
...
music_file_8 = MusicFile.create(name: "RaseroTeam", title: "Rasero Team Fuck Out", description: "Lost after 14 years, so rare even I forgot about it! This chune was added in our patch to Reject's demo. We did this tune in response to some guys in Poland called the RASERO TEAM, who thought they were being clever by doing a demo called 'Senior Fucks out'! You wot, mate?!? That demo was just shit, and the \"music\" didn't even get the bass frequencies right! Maybe you can't code to our level, guys, but at least you can get the chunes sorted! So that's what I did, just to show them who's boss. A cool jungle remix of a shite lamers tune, know what I'm sayin'?", main_file: link_66)
