...
demo_1 = Demo.create("name"=>"atuck", "title"=>"aNaL tUcK!!!11", "platform"=>"aTaR1 fAlC0n 0nLy!!!1!", "size"=>60.0, "gallery_id"=>1, "demo_order"=>1, "link_id"=>15, "release_date" => "1995-04-16 18:55:00 UTC")
demo_2 = Demo.create("name"=>"colonic", "title"=>"c0L0n1C 1rR1gAt10N!!!11", "platform"=>"aTaR1 fAlC0n 0nLy!!!1!", "size"=>63.0, "gallery_id"=>2, "demo_order"=>2, "link_id"=>20, "release_date" => "1995-08-09 04:19:00 UTC")
demo_3 = Demo.create("name"=>"ladmds2", "title"=>"//a l;AuB3 dU mAt1N dU s01R iI//", "platform"=>"aTaR1 sT3/fAlC0n 0nLy!!!1!", "size"=>642.0, "gallery_id"=>3, "demo_order"=>3, "link_id"=>25, "release_date" => "1996-03-01 01:18:00 UTC")
demo_4 = Demo.create("name"=>"airdirt", "title"=>"The <strong>AIR DIRT demo!</strong>", "platform"=>"aTaR1 sT3/fAlC0n 0nLy!!!1!", "size"=>328.0, "gallery_id"=>4, "demo_order"=>4, "link_id"=>30, "release_date" => "1996-10-31 15:49:00 UTC")
demo_5 = Demo.create("name"=>"floormat", "title"=>"The ST FLOORMAT demo!", "platform"=>"aTaR1 sTfM/sT3/fAlC0n/pAc1F1St 0nLy!!!1!", "size"=>34.0, "gallery_id"=>5, "demo_order"=>5, "link_id"=>35, "release_date" => "1997-02-24 13:14:00 UTC")
demo_6 = Demo.create("name"=>"teckno", "title"=>"The &quot;ANTI-TECKNO&quot; TECKNO demo!", "platform"=>"aTaR1 sTfM/sT3/fAlC0n/pAc1F1St 0nLy!!!1!", "size"=>47.0, "gallery_id"=>6, "demo_order"=>6, "link_id"=>39, "release_date" => "1997-05-05 16:40:00 UTC")
demo_7 = Demo.create("name"=>"xmas97", "title"=>"The XMAS CARD 97 demo!", "platform"=>"aTaR1 fAlC0n 0nLy!!!1!", "size"=>488.0, "gallery_id"=>7, "demo_order"=>7, "link_id"=>68, "release_date" => "1997-12-24 12:41:00 UTC")
demo_8 = Demo.create("name"=>"dadplazz", "title"=>"DadPlazz!!", "platform"=>"aTaR1 fAlC0n 0nLy!!!1!", "size"=>0.125, "gallery_id"=>8, "demo_order"=>8, "link_id"=>69, "release_date" => "1998-01-20 00:21:58 UTC")
demo_9 = Demo.create("name"=>"mono", "title"=>"MONO-MENTAL!!!!", "platform"=>"aTaR1 sTfM/sT3/fAlC0n 0nLy!!!1!", "size"=>112.0, "gallery_id"=>9, "demo_order"=>9, "link_id"=>70, "release_date" => "1998-04-05 22:30:00 UTC")
demo_10 = Demo.create("name"=>"fake", "title"=>"The ULTIMATE FAKE DEMO!!!", "platform"=>"aTaR1 fAlC0n/JTFM/JTE/Hasbro Transformer!!/pAc1F1st PC 0nLy!!!1!", "size"=>15.0, "gallery_id"=>10, "demo_order"=>10, "link_id"=>71, "release_date" => "1998-04-05 22:30:00 UTC")
demo_file_collection_1 = DemoFileCollection.create("demo_id"=>1, "order"=>nil, "link_id"=>16)
demo_file_collection_2 = DemoFileCollection.create("demo_id"=>1, "order"=>nil, "link_id"=>17)
demo_file_collection_3 = DemoFileCollection.create("demo_id"=>1, "order"=>nil, "link_id"=>18)
demo_file_collection_4 = DemoFileCollection.create("demo_id"=>2, "order"=>nil, "link_id"=>21)
demo_file_collection_5 = DemoFileCollection.create("demo_id"=>2, "order"=>nil, "link_id"=>22)
demo_file_collection_6 = DemoFileCollection.create("demo_id"=>2, "order"=>nil, "link_id"=>23)
demo_file_collection_7 = DemoFileCollection.create("demo_id"=>3, "order"=>nil, "link_id"=>26)
demo_file_collection_8 = DemoFileCollection.create("demo_id"=>3, "order"=>nil, "link_id"=>27)
demo_file_collection_9 = DemoFileCollection.create("demo_id"=>3, "order"=>nil, "link_id"=>28)
demo_file_collection_10 = DemoFileCollection.create("demo_id"=>4, "order"=>nil, "link_id"=>31)
demo_file_collection_11 = DemoFileCollection.create("demo_id"=>4, "order"=>nil, "link_id"=>32)
demo_file_collection_12 = DemoFileCollection.create("demo_id"=>4, "order"=>nil, "link_id"=>33)
demo_file_collection_13 = DemoFileCollection.create("demo_id"=>5, "order"=>nil, "link_id"=>36)
demo_file_collection_14 = DemoFileCollection.create("demo_id"=>5, "order"=>nil, "link_id"=>37)
demo_file_collection_15 = DemoFileCollection.create("demo_id"=>6, "order"=>nil, "link_id"=>40)
demo_file_collection_16 = DemoFileCollection.create("demo_id"=>6, "order"=>nil, "link_id"=>41)
